...
function App() {
  ...
  const btext = "Click Here For Dark Mode";
  ...
  function toggleButton() {
    if (buttonText === "Click Here For Light Mode") {
      setButtonText("Click Here For Dark Mode");
      setColor("black")
      console.log(buttonText)
      changeStyle("white");
    } else {
      setButtonText("Click Here For Light Mode");
      setColor("white");
      console.log(buttonText)
      changeStyle("black");
    }
